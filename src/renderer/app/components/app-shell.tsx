...
import { ShellConnectStatus } from "~/components/shell/shell-connect-status"
...
const mainNavItems = [
  { href: "/", label: "工作台", Icon: Home, end: true },
  { href: "/create", label: "创作", Icon: PenLine, end: false },
  { href: "/knowledge", label: "知识", Icon: Brain, end: false },
  { href: "/chat", label: "对话", Icon: MessageSquare, end: false },
] as const
...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      ...
      <aside className="z-30 flex w-[220px] shrink-0 flex-col border-r border-border/60 bg-card shadow-sm">
